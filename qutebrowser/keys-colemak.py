...
config.bind(",u", "spawn --userscript greasyupd")
...
config.bind(
    "gf",
    "hint links yank;; cmd-later 3000 spawn --userscript ghraw;; cmd-later 3600 open {clipboard}",
)
config.bind(
    "gF",
    "hint links yank;; cmd-later 3000 spawn --userscript ghraw;; cmd-later 3600 open -t {clipboard}",
)
...
config.bind("tp", "cmd-set-text -s :open -p")
config.bind("Tn", "cmd-set-text -s :open -t {url:pretty}")
config.bind("Tt", "cmd-set-text -s :open -t -r {url:pretty}")
config.bind("Tw", "cmd-set-text -s :open -w {url:pretty}")
config.bind("Tp", "cmd-set-text -s :open -p {url:pretty}")
config.bind("tbn", "cmd-set-text -s :open -t br")
config.bind("tb", "cmd-set-text -s :open -t -r br")
config.bind("tbw", "cmd-set-text -s :open -w br")
config.bind("tbp", "cmd-set-text -s :open -p br")
config.bind("Tbn", "cmd-set-text -s :open -t br {url:pretty}")
config.bind("Tb", "cmd-set-text -s :open -t -r br {url:pretty}")
config.bind("Tbw", "cmd-set-text -s :open -w br {url:pretty}")
config.bind("Tbp", "cmd-set-text -s :open -p br {url:pretty}")
config.bind("u", "undo")
...
config.bind("aD", "download")
config.bind("ard", "hint --rapid links download")
config.bind("rd", "hint --rapid links download")
...
# config.bind("dw", "tab-close --next")
# config.bind("db", "tab-close --prev")
# config.bind("dn", "yank ;; tab-close ;; tab-next")
# config.bind("dp", "yank ;; tab-close ;; tab-prev")
# config.bind("D", "yank ;; tab-close ;; tab-prev")
## use rather macros
...
# config.bind("xc", "jseval -f /home/daru/.config/qutebrowser/userscripts/getCookie.js")
config.bind("xc", "spawn --userscript getCookie")
...
config.bind("Xm", "hint links spawn --detach mpv {hint-url}")
config.bind("Xp", "hint links spawn zathura {hint-url}")
config.bind("xi", "hint images spawn nsxiv-url {hint-url}")
config.bind("xd", "hint links spawn kitty --directory=~/Downloads/ yt-dlp {hint-url}")
config.bind("xm", "hint links spawn --detach mpv {hint-url}")
config.bind("xy", "hint links spawn --detach mpv {hint-url}")
config.bind("xY", "spawn --detach mpv {url}")
config.bind("xp", "hint links spawn zathura {hint-url}")
config.bind("xx", "stop")
...
config.bind("<Ctrl-D>", "scroll-px 0 800")
config.bind("<Ctrl-U>", "scroll-px 0 -800")
