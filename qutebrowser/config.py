## See https://github.com/qutebrowser/qutebrowser/qutebrowser/config/configdata.yml for more info
## config-write-py to auto write new config (backup old one)
...
c.hints.selectors = {
    ...
    "inputs": [
        ...
        'input[type="url"]',
        'input[type="week"]',
        ## This is github input, it might be not desirable
        ## when going into issues or pullrequests tab directly.
        ## When using Ctrl-K use `/` to get in, `Esc` out of input instead.
        #'span[id="qb-input-query"]',
        "input:not([type])",
        '[contenteditable]:not([contenteditable="false"])',
        "textarea",
    ],
